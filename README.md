...
Typing `awesome` into the SECURED pill unlocks a full "Cryptographic Flavor
Generator" skin — a green-on-black Matrix theme with animated rain. Type `corp`
to return to the standard Ace-themed Corp view.

In passphrase mode, Awesome Mode adds a **Flavor System**: 16 themed word pools
(D&D, Gibson, Star Trek, Star Wars, Cosmic Horror, Mythology, Linux Kernel,
Corp Speak, Pirate, Dune, Dark Souls, Latin, Tolkien, Victorian, Arthurian,
Hacker) you can blend into your passphrases.
